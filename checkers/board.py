import pygame
from .constants import BROWN, WHITE, ROWS, SQUARE_SIZE, COLS, BAMBOO, BLACK
    ...
    def draw_squares(self, win):
        ...
        for row in range(ROWS):
            for col in range(row % 2, COLS, 2):
                pygame.draw.rect(win, BAMBOO, (row * SQUARE_SIZE, col * SQUARE_SIZE, SQUARE_SIZE, SQUARE_SIZE))
